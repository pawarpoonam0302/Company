...
public class Operation {
    ...
    public static void main(String[] args) {
        ...
        switch (department.toLowerCase()) {
            ...
            default:
                logger.info("Invalid department entered. Please choose from HR, Finance, or IT.");
                break;
        }
    ...
    private static void handleHRDepartment() {
        ...
        switch (choice) {
            ...
            case 5:
                ...
                break;
            default:
                logger.warn("Invalid choice for HR Department.");
                break;
        }
    }
    ...
    private static void handleITDepartment() {
        ...
        switch (choice) {
            ...
            case 4:
                ...
                break;
            default:
                logger.warn("Invalid choice for IT Department.");
                break;
        }
    }
    ...
    private static void viewAssetById() {
        ...
        if (asset != null) {
            logger.info("Asset Details: " + asset);
        } else {
    ...
    private static void handleFinanceDepartment() {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                break;
            default:
                logger.warn("Invalid choice for Finance Department.");
                break;
        }
    }
